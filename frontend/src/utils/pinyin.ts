const PINYIN_MAP: Record<string, string> = {
  ...
  '过': 'guo', '还': 'hai', '孩': 'hai', '海': 'hai', '害': 'hai', '汉': 'han', '好': 'hao',
  '喝': 'he', '河': 'he', '黑': 'hei', '很': 'hen', '红': 'hong',
  ...
  '级': 'ji', '极': 'ji', '季': 'ji', '继': 'ji', '纪': 'ji', '济': 'ji',
  '既': 'ji', '家': 'jia', '加': 'jia', '价': 'jia', '架': 'jia',
  ...
  '旁': 'pang', '跑': 'pao', '泡': 'pao', '朋': 'peng', '棚': 'peng', '皮': 'pi',
  ...
  '汽': 'qi', '器': 'qi', '恰': 'qia', '千': 'qian', '前': 'qian', '钱': 'qian',
  '浅': 'qian', '强': 'qiang', '墙': 'qiang', '抢': 'qiang', '悄': 'qiao', '桥': 'qiao', '巧': 'qiao',
  '敲': 'qiao', '壳': 'qiao', '且': 'qie', '切': 'qie', '茄': 'qie', '青': 'qing',
  ...
  '任': 'ren', '日': 'ri', '容': 'rong', '肉': 'rou', '如': 'ru', '入': 'ru',
  ...
  '舍': 'she', '射': 'she', '涉': 'she', '深': 'shen', '什': 'shen', '神': 'shen',
  ...
  '像': 'xiang', '项': 'xiang', '相': 'xiang', '香': 'xiang', '箱': 'xiang', '详': 'xiang',
  '响': 'xiang', '享': 'xiang', '小': 'xiao', '晓': 'xiao', '孝': 'xiao', '校': 'xiao',
  '笑': 'xiao', '效': 'xiao', '些': 'xie', '歇': 'xie', '协': 'xie', '斜': 'xie', '写': 'xie',
  '谢': 'xie', '心': 'xin', '辛': 'xin', '新': 'xin', '信': 'xin', '兴': 'xing',
  ...
  '哑': 'ya', '亚': 'ya', '研': 'yan', '言': 'yan', '岩': 'yan', '炎': 'yan',
  ...
  '涌': 'yong', '永': 'yong', '泳': 'yong', '由': 'you', '油': 'you', '游': 'you', '友': 'you',
  '有': 'you', '又': 'you', '右': 'you', '幼': 'you', '于': 'yu',
  '鱼': 'yu', '雨': 'yu', '与': 'yu', '语': 'yu', '预': 'yu', '域': 'yu', '欲': 'yu',
  '遇': 'yu', '育': 'yu', '元': 'yuan', '原': 'yuan', '园': 'yuan', '圆': 'yuan', '员': 'yuan',
  '袁': 'yuan', '远': 'yuan', '院': 'yuan', '愿': 'yuan', '月': 'yue', '约': 'yue',
  ...
  '洲': 'zhou', '粥': 'zhou', '轴': 'zhou', '肘': 'zhou', '皱': 'zhou', '骤': 'zhou',
...
export function processManuscript(text: string): Sentence[] {
